...
var SingleDayContentRow = function (_React$Component) {
  _inherits(SingleDayContentRow, _React$Component);

  function SingleDayContentRow() {
    var _temp, _this, _ret;

    _classCallCheck(this, SingleDayContentRow);
  ...
  SingleDayContentRow.prototype.getRowLimit = function getRowLimit() {
  ...
  SingleDayContentRow.prototype.render = function render() {
    var _props = this.props,
        ...
        props = _objectWithoutProperties(_props, ['events', 'range', 'className', 'renderForMeasure', 'startAccessor', 'endAccessor', 'minRows', 'maxRows', 'eventComponent', 'eventWrapperComponent', 'intervals']);
    ...
    var segments = this.segments = events.map(function (evt) {
      return (0, _eventLevels2.singleDayEventSegments)(evt, first, last, {
