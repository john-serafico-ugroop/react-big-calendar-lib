...
var _SingeDayContentCeiling = require('./SingeDayContentCeiling');

var _SingeDayContentCeiling2 = _interopRequireDefault(_SingeDayContentCeiling);
  ...
  SingleDayGrid.prototype.render = function render() {
    ...
    events.forEach(function (event) {
      if ((0, _eventLevels.inRange)(event, start, end, _this2.props)) {
        if (event.renderSection === 'content' || event.renderSection === undefined) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: 'rbc-singleDay-ceiling' },
        _react2.default.createElement(_SingeDayContentCeiling2.default, {
          minRows: 1,
          range: range,
