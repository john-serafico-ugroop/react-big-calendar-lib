...
function singleDayEventSegments(event, first, last, _ref2, timeRange) {
  ...
  var _dates$roundMins = _dates2.default.roundMins(eStartMin, eEndMin),
      roundStartMins = _dates$roundMins.roundStartMins,
      roundEndMins = _dates$roundMins.roundEndMins;
