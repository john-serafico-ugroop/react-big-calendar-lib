...
exports.TIME_INTERVAL = undefined;
...
var TIME_INTERVAL = exports.TIME_INTERVAL = function TIME_INTERVAL() {
  var start = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  var end = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 24;
  var interval = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0.25;
...
var dates = _extends({}, _dateArithmetic2.default, {
  ...
  stripDate: function stripDate(date) {
    var dayWrapper = (0, _moment2.default)(date);
    dayWrapper.set({ y: 1, M: 0, date: 1 });
    return dayWrapper.toDate();
  },
  roundMins: function roundMins(start, end) {
    var FIFTEEN_INTERVAL = 15;
    var roundStartMins = void 0;
    var roundEndMins = void 0;
    ...
    return { roundStartMins: roundStartMins, roundEndMins: roundEndMins };
  }
});
