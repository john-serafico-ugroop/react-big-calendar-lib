  ...
  EventRow.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      segments.reduce(function (row, _ref, li) {
        ...
        row.push(!fixedSpan ? _EventRowMixin2.default.renderSpan(slots, span, key, content) : _EventRowMixin2.default.renderFixedSpan(key, content));
...
EventRow.propTypes = _extends({
  ...
  fixedSpan: _propTypes2.default.bool
}, _EventRowMixin2.default.propTypes);
EventRow.defaultProps = _extends({
  fixedSpan: false
